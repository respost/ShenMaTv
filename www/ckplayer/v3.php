...
$id = base64_encode($id);?>
	var purl
	var vid1='<?php echo $id;?>&style=5&qxd=bq&page=<?php echo $page;?>';
	var vid2='<?php echo $id;?>&style=5&type=mp4&page=<?php echo $page;?>';
    var vid3='<?php echo $id;?>&style=5&type=3gphd&page=<?php echo $page;?>';
...
<?PHP }else{?>	
   <?php 
    ...
    $id = base64_encode($id);?>
    var vid='<?php echo $id;?>';
	var purl1='pc.php?id='+vid+'&style=5&page=<?php echo $page;?>';
	var purl2='android.php?id='+vid+'&style=5&page=<?php echo $page;?>';
	var purl3='android.php?id='+vid+'&style=5&page=<?php echo $page;?>';
...
<?PHP }else{
	...
	$id = base64_encode($id);?>
	var vid='<?php echo $id;?>';
	var purl='youku.php?id='+vid+'&style=5&page=<?php echo $page;?>';
	var ljfs=4;
<?php }}?>
	var flashvars={
<?php if($czpd==1){?>
