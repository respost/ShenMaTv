...
<span id="index"><i class="ico07"><img src="/img/logo.png" width="88px" class="h" /></i></span><i class="ico21">红包记录</i>
...
$total=mysql_query("SELECT SUM(money) AS num FROM ubohbjl  ".$sql."");
...
<tr class="pn">
  <td height="40" colspan="2" style="font-size:14px;">总共抢了<?php echo $count;?>个红包，共计<?php echo $money_count;?>元</td>
  </tr>
<?php 
...
<tr class="pn">
  ...
  <td height="35" align="center" style="padding-right:5px;"><div class="left"><span><?php echo $name;?></span><span style="color:#999;"><?php echo $sctime;?></span></div><div class="right"><span><?php echo $money;?>元</span></div></td>
  </tr>
<?php 
$i++;  
};
