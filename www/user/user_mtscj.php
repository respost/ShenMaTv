...
dbdel(se2tusc,$type);
echo msglayerurl("删除成功！",8,"user_mtscj.php");
}
...
<span id="index"><i class="ico07"><img src="/img/logo.png" width="88px" class="h" /></i></span><i class="ico21">美图收藏</i>
...
<li>
<h2 class="t2 l" style="padding-top:1.5%;color:red;"><img src="/img/ustb.png" width="12" height="12" style="margin-right:5px;">美图收藏</h2>
...
$sql = "WHERE uid=".$uid;
$Page_size=10; 
$result=mysql_query("SELECT * FROM  se2tusc ".$sql." "); 
...
<tr>
  <td align="center" style="line-height:40px;" width="20%"><strong>封面图片</strong></td>
...
<?php 
$query = mysql_query("select * from  se2tusc ".$sql." ".$order." limit $offset, $Page_size");
$i=1;
