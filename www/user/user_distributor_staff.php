...
<span id="index"><i class="ico07"><img src="/img/logo.png" width="88px" class="h" /></i></span><i class="ico21">推广会员</i>
...
<li>
<h2 class="t2 l" style="padding-top:1.5%;color:red;"><img src="/img/ustb.png" width="12" height="12" style="margin-right:5px;">推广会员</h2>
<span class="r login_yj"><i class="fa fa-angle-right fa-lg"></i></span>
</li>
</a> 
...
$sql = "WHERE fx_uid_1=".$uid." or fx_uid_2=".$uid." or fx_uid_3=".$uid;
$Page_size=10; 
$result=mysql_query("SELECT * FROM  ubofx ".$sql." "); 
...
<tr>
  <td align="center" style="line-height:40px;" width="23%"><strong>会员号</strong></td>
  <td align="center" style="line-height:40px;" width="17%"><strong>等级</strong></td>
  <td align="center" style="line-height:40px;" width="17%"><strong>分成</strong></td>
  <td height="40" align="center" style="line-height:40px;"width="17%" ><strong>下线</strong></td>
<td height="40" align="center" style="line-height:40px;" width="26%"><strong>加入日期</strong></td>
</tr>
<?php 
$query = mysql_query("select * from  ubofx ".$sql." ".$order." limit $offset, $Page_size");
$i=1;
...
<tr class="re">
  ...
  <td style="border-top: 1px solid #ddd;line-height:45px;" align="center"><?php echo $grade;?>级</td>
  <td height="35" style="border-top: 1px solid #ddd;line-height:45px;" align="center"><?php echo $divide;?>%</td>
  <td height="35" style="border-top: 1px solid #ddd;line-height:45px;" align="center"><?php echo $people;?>人</td>
