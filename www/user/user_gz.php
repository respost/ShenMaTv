...
<span id="index"><i class="ico07"><img src="/img/logo.png" width="88px" class="h" /></i></span><i class="ico21">我的关注</i>
...
<a href="user_scj.php">
<li>
<h2 class="t2 l" style="padding-top:1.5%;"><img src="/img/ustb.png" width="12" height="12" style="margin-right:5px;">视频收藏</h2>
<span class="r login_yj"><i class="fa fa-angle-right fa-lg"></i></span>
</li>
</a>
<a href="user_gz.php">
<li>
<h2 class="t2 l" style="padding-top:1.5%;color:red;"><img src="/img/ustb.png" width="12" height="12" style="margin-right:5px;">我的关注</h2>
<span class="r login_yj"><i class="fa fa-angle-right fa-lg"></i></span>
</li>
</a> 
</section>
...
function uname($id,$lx)
{
	...
	$name=$fname['name'];
    $return=$fname['money']."|".$fname['concern']."|".$fname['trends'];
	}else{
...
<tr>
  <td align="center" style="line-height:40px;" width="18%"><strong>头像</strong></td>
<td height="40" align="left" style="line-height:40px;"><strong>详情</strong></td>
...
$concern=$hysj[1];
$trends=$hysj[2];
$money=round($hysj[0],2);
?> 
<tr class="re">
  <td style="border-top: 1px solid #ddd;line-height:45px;" align="center"><span class="touxiang" style="background-image:url('<?php $imis = substr_count($pic,'http'); if ($imis==0){ $pic=str_replace("//","/","/".$pic); echo $pic;}else{echo $pic;}?>')"></span></td>
<td height="35" style="border-top: 1px solid #ddd;line-height:45px;" align="center"><div class="guanzhu"><span class="left"><i></i><?php echo $name;?></span><span class="right"><span class="right_1"><i class="gz"></i>关注：<?php echo $concern;?>人</span><span class="right_2"><i class="sp"></i>视频：<?php echo $trends;?>个</span></span></div></td>
<td height="35" style="border-top: 1px solid #ddd;line-height:45px;" align="center"><div class="caozuo"><span class="left"><a href="?id=<?php echo $scid;?>" target="msgubotj" onClick="return window.confirm(&quot;单击“确定”取消。单击“取消”撤销。&quot;);">取消</a></span><span class="right"><a href="/<?php echo $url;?>">逛逛</a></span></div></td>
</tr>
<?php 
$i++;  
};
