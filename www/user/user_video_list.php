...
echo msglayerurl("删除成功！",8,"user_video_list.php");
}
...
<span id="index"><i class="ico07"><img src="/img/logo.png" width="88px" class="h" /></i></span><i class="ico21">视频管理</i>
...
<li>
<h2 class="t2 l" style="padding-top:1.5%;"><img src="/img/ustb.png" width="12" height="12" style="margin-right:5px;">发布视频</h2>
<span class="r login_yj"><i class="fa fa-angle-right fa-lg"></i></span>
</li>
</a> 
<a href="user_video_list.php">
<li>
<h2 class="t2 l" style="padding-top:1.5%;color:red;"><img src="/img/ustb.png" width="12" height="12" style="margin-right:5px;">视频管理</h2>
<span class="r login_yj"><i class="fa fa-angle-right fa-lg"></i></span>
</li>
</a> 
</section>
...
<tr>
	...
	<td height="40" align="center" style="line-height:40px;"width="58%"><strong>视频标题</strong></td>
...
<tr class="re">
	...
	<td height="35" style="border-top: 1px solid #ddd;line-height:45px;" align="center">
	<div class="xiangqing">
	<span class="left"><i></i><?php echo cutSubstr($name);?></span>
	<span class="right"><i></i><?php echo $sctime;?></span>
	</div>
	</td>
	<td height="35" style="border-top: 1px solid #ddd;line-height:45px;" align="center"><div class="caozuo"><span class="left"><a href="?id=<?php echo $scid;?>&division=<?php echo $division;?>" target="msgubotj" onClick="return window.confirm(&quot;单击“确定”删除。单击“取消”撤销。&quot;);">删除</a></span><span class="right"><?php if ($a[censor]>0){?><a href="javascript:;">审核中</a><?php }else{?><a href="/<?php echo $url;?>" target="_blank">观看</a><?php }?></span></div></td>
</tr>
<?php 
$i++;  
};
...
<p align="center" style="font-size:12px;color:#333">当前第<font color="red"><?php echo $page ?></font>页 总共<font color="blue"><?php echo $pages ?></font>页</p>
<?php echo $key?>
</div>
