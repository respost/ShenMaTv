...
<span id="index"><i class="ico07"><img src="/img/logo.png" width="88px" class="h" /></i></span><i class="ico21">推广记录</i>
...
<li>
<h2 class="t2 l" style="padding-top:1.5%;"><img src="/img/ustb.png" width="12" height="12" style="margin-right:5px;">宣传推广</h2>
<span class="r login_yj"><i class="fa fa-angle-right fa-lg"></i></span>
</li>
</a> 
<a href="user_share_list.php">
<li>
<h2 class="t2 l" style="padding-top:1.5%;color:red;"><img src="/img/ustb.png" width="12" height="12" style="margin-right:5px;">推广记录</h2>
<span class="r login_yj"><i class="fa fa-angle-right fa-lg"></i></span>
</li>
</a> 
</section>
...
$sql = "WHERE uid=".$uid;
$Page_size=10; 
$result=mysql_query("SELECT * FROM  ubotgjl ".$sql." "); 
...
<tr>
  <td align="center" style="line-height:40px;" width="18%"><strong>编号</strong></td>
  <td align="center" style="line-height:40px;" width="32%"><strong>IP地址</strong></td>
  <td height="40" align="center" style="line-height:40px;"width="30%" ><strong>日期</strong></td>
<td height="40" align="center" style="line-height:40px;" width="20%"><strong>金额</strong></td>
</tr>
<?php 
$query = mysql_query("select * from  ubotgjl ".$sql." ".$order." limit $offset, $Page_size");
$i=1;
...
?> 
<tr class="re">
  <td style="border-top: 1px solid #ddd;line-height:45px;" align="center"><?php echo $id;?></td>
  <td style="border-top: 1px solid #ddd;line-height:45px;" align="center"><?php echo $ip;?></td>
