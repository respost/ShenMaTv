...
<span id="index"><i class="ico07"><img src="/img/logo.png" width="88px" class="h" /></i></span><i class="ico21">提现明细</i>
...
<li>
<h2 class="t2 l" style="padding-top:1.5%;color:red;"><img src="/img/ustb.png" width="12" height="12" style="margin-right:5px;">提现明细</h2>
<span class="r login_yj"><i class="fa fa-angle-right fa-lg"></i></span>
</li>
</a>
</section>
...
$sql = "WHERE uid=".$uid;
$Page_size=10; 
$result=mysql_query("SELECT * FROM  ubopayjs ".$sql." ".$order); 
...
<tr>
  <td align="center" style="line-height:40px;" width="23%"><strong>ID号</strong></td>
  <td align="center" style="line-height:40px;" width="17%"><strong>金额</strong></td>
  <td align="center" style="line-height:40px;" width="17%"><strong>手续费</strong></td>
  <td height="40" align="center" style="line-height:40px;"width="17%" ><strong>状态</strong></td>
<td height="40" align="center" style="line-height:40px;" width="26%"><strong>申请日期</strong></td>
</tr>
<?php 
$query = mysql_query("select * from  ubopayjs ".$sql." ".$order." limit $offset, $Page_size");
$i=1;
while ($a=mysql_fetch_array($query)) { 
$id=$a[id];
$jiesuan=$a[jiesuan];
$sctime=date('Y-m-d',$a[sqshijian]);
$money=round($a[money]);
?> 
<tr class="re">
  <td style="border-top: 1px solid #ddd;line-height:45px;" align="center">TX00<?php echo $id;?></td>
  <td style="border-top: 1px solid #ddd;line-height:45px;" align="center">￥<?php echo $money*0.95;?>元</td>
  <td height="35" style="border-top: 1px solid #ddd;line-height:45px;" align="center">￥<?php echo $money*0.05;?>元</td>
  <td height="35" style="border-top: 1px solid #ddd;line-height:45px;" align="center"><?php if ($jiesuan==1){echo "待处理";}else{echo "已处理";}?></td>
