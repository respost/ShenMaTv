...
echo msglayer("解析不能为空！",3);
}elseif($_POST[lyid]==null){
echo msglayer("来源ID不能为空！",3);
}else{
$type="pid='$_POST[name]',uid='$_POST[url]',shijian='$_POST[lyid]',money='$_POST[jiexi]' where id='$id'";
upalldt(ubotj3,$type);
echo msglayerurl("修改成功，返回页面",4,"laiyuan.php");
}
}
$del=$_GET[action];
$delid=$_GET[delid];
...
$type="id='$delid'";
dbdel(ubotj3,$type);
echo msglayerurl("删除成功，返回页面",8,"laiyuan.php");
}
?>
...
<li class="layui-this"><a href="laiyuan.php">添加来源</a></li>
</ul>
...
<tr>
<td width="100" scope="col" height="26"><p>来源名称：</p></td>
<td scope="col">
<?php if($id==null){ ?>
...
<tr>
<td scope="col" height="26"><p>来源ID号：</p></td>
<td scope="col">
<?php if($id==null){ ?>
...
<tr>
<td scope="col" height="26"><p>规则设置：</p></td>
<td scope="col">
<?php if($id==null){ ?>
...
<tr>
<td scope="col" height="26"><p>解析接口：</p></td>
<td scope="col">
<?php if($id==null){ ?>
...
<div class="layui-tab layui-tab-brief">
<ul class="layui-tab-title">
<li class="layui-this"><a href="laiyuan.php">来源列表</a></li>
</ul>
<div class="layui-tab-content">
<div class="layui-tab-item layui-show">
<table width="100%" class="layui-table" cellspacing="0" cellpadding="0">
<tbody>
<tr class="color1">
  <td><p align="center"><b>来源ID号</b></p></td>
 <td><p align="center"><b>来源名称</b></p></td>
 <td><p align="center"><b>来源规则</b></p></td>
...
<td align="center"><p align="center"><a href="laiyuan.php?id=<?php echo $a[id]?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>&nbsp;<a  onclick="return checkdel()"  target="msgubotj"  href="laiyuan.php?action=del&delid=<?php echo $a[id]?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete" >删除</a> </p></td>
</tr>
<?php 
} 
