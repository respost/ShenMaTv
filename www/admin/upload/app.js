requirejs.config({
    baseUrl: '../../dist',
    paths: {
        jquery: '../admin_2018/upload/jquery'
    }
});
...
require([ 'webuploader.flashonly' ], function( WebUploader ) {
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            threads: 1,
            duplicate: true,
            server: '../../admin_2018/fileupload.php',
            accept: {
            title: 'Images',
            extensions: 'mp4,flv',
            mimeTypes: '.mp4,.flv'
		...
		var spurl = parent.document.getElementById('url').value;
		spurl=spurl+"|"+fileurl;
		spurl="|"+spurl;
		spurl=spurl.replace('||', '');
		parent.document.getElementById('url').value=spurl;
		parent.document.getElementById('name').value=title;
        });
