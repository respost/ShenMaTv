...
$type="id='$delid'";
dbdel(ubotgjl,$type);
echo msglayerurl("删除成功，返回页面",8,"share_list.php");
}
$array = $_POST["del_id"]; 
if(!empty($array)){
$del_sun=count($array); 
...
echo"<script>alert('删除成功');location.href='share_list.php'</script>";  
}
?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<li class="layui-this"><a href="share_list.php">推广记录</a></li>
</ul>
...
<tr class="color1">
<th width="4%">&nbsp;</th>
<th width="12%" align="center" >推广ID</th>
<th width="12%" align="center" >注册用户</th>
<th width="12%" align="center" >IP地址</th>
<th align="center" >访问终端</th>
<th width="10%" align="center" valign="middle" >获得金额</th>
<th width="10%" align="center">记录时间</th>
...
?> 
<tr>
  <td colspan=17 style="padding-left:20px;" height="38"><label id="chkAll"><input class="demo--radioInput" style="margin:0;" type="checkbox" name="chkAll" id="chk" title="全选/反选" onClick="All(this, 'del_id[]')" />
