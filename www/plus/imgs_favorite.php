...
$uid=$user['id'];
$scjc=getone("select * from se2tusc WHERE uid='".$uid."' and url='".$url."'");
if (empty($scjc))
{
$pic=$neirong[pic];
$name=$neirong[name];
